				...
				<!--<div if="$!productList.isEmpty()">-->
                        ...
                        ?>
                                    <div class="panel panel-default" id="productPanel" each="entry,status : $productList">
                                            <div class="panel-heading" text="$entry.name"><?php echo $product['name'] ?></div>
                                            <div class="panel-body">
                                            <!-- ejemplo de como se mostraran los productos -->
                                                    <div class="col-sm-4">
                                                            <img class="img-thumbnail img-responsive"
                                                            src="<?php echo $product['urlImage'] ?>"  height="300" width="200">
                                                    </div>
                                                    <div class="col-sm-4" style="margin-top: 10%;">
                                                            <h4 th:text="${entry.description}"><?php echo $product['description'] ?></h4>
                                                    </div>
                                            <div class="col-sm-4" style="margin-top: 10%;">
                                                            <h1 >CRC <?php echo $product['price'] ?></h1>
                                                             <h1 >US <?php echo substr($product['price']/$return2,0,6) ?></h1>
                                                    </div>
