					...
					<div class="panel-body">
							...
							<!-- muestra -->
                                                        ...
                                                        <li class="list-group-item">
                                                            <label class="btn btn-link"></label>Tecnologia</li>
							<li class="list-group-item">
                                                            <label class="btn btn-link"></label>Electrodomesticos</li>
							<li class="list-group-item">
                                                            <label class="btn btn-link"></label>Ropa</li>
							<li class="list-group-item">
                                                            <label class="btn btn-link"></label>Libros</li>
							<li class="list-group-item">
                                                            <label class="btn btn-link"></label>Accesorios</li>
                                                        <li class="list-group-item">
                                                            <label class="btn btn-link"></label>Muebles</li>
							</li>
				...
				<!--<div if="$!productList.isEmpty()">-->
                        ...
                        ?>
                                    ...
                                    <div class="panel panel-default" id="productPanel" each="entry,status : $productList">
                                            <div class="panel-heading" text="$entry.name"><?php echo $products2['name'] ?></div>
                                            <div class="panel-body">
                                            <!-- ejemplo de como se mostraran los productos -->
                                                    <div class="col-sm-4">
                                                            <img class="img-thumbnail img-responsive"
                                                            src="<?php echo $products2['urlImage'] ?>"  height="300" width="200">
                                                    </div>
                                                    <div class="col-sm-4" style="margin-top: 10%;">
                                                            <h4 th:text="${entry.description}"><?php echo $products2['description'] ?></h4>
                                                    </div>
                                            <div class="col-sm-4" style="margin-top: 10%;">
                                                            <h1 >CRC <?php echo $products2['price'] ?></h1>
                                                             <h1 >US <?php echo substr($products2['price']/$return2,0,6) ?></h1>
                                                    </div>
